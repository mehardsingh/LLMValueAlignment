...
python src/probe_model/probe_all_prompts.py --dataset_fp wvs_data/questionaire/clean_wvs.csv --prompt_dir src/prompt_templates/Llama-2 --model_name meta-llama/Llama-2-70b-chat-hf --result_dir results/Llama-2-70b-chat-hf